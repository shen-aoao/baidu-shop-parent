...
public class CategoryEntity {
    ...
    @NotEmpty(message = "分类名称不能为空",groups = {BaiduOperation.Add.class,BaiduOperation.Update.class})
    private String name;
    ...
    @NotNull(message = "是否为父级节点不能为空",groups = {BaiduOperation.Add.class})
    private Integer isParent;

    @ApiModelProperty(value = "排序",example = "1")
    @NotNull(message = "排序不能为空",groups = {BaiduOperation.Add.class})
